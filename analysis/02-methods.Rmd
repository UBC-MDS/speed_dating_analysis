...
Analysis and graphs were produced using the R programming language (R Core Team 2019) as well as the following R packages: tidyverse (Wickham 2017), knitr (Xie 2014). For the full code used to produce this report and analyses, please see: https://github.com/wenyunie/speed_dating_analysis.
