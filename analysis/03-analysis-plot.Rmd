...
our_t_test(data,attr_other_rating,attr5_1,version='paired')
```

```{r message=FALSE, warning=FALSE,echo=FALSE}
our_t_test(data,attr_other_rating,attr5_1,version='diff')
```
...
```{r message=FALSE, warning=FALSE,echo=FALSE}
pearson_corr(data, attr_other_rating, attr5_1, alternative='greater')
```
